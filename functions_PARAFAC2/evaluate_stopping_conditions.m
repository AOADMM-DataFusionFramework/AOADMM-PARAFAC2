function [stop] = evaluate_stopping_conditions(f_tensors,f_PAR2_couplings,f_constraints,f_tensors_old,f_PAR2_couplings_old,f_constraints_old,options)
...
stop = stop_tensors & stop_PAR2_couplings & stop_constraints;
